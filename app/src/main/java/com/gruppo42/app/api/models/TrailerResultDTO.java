...
public class TrailerResultDTO implements Parcelable {
    ...
    public TrailerResultDTO(String id, String iso_639_1, String iso_3166_1, String key, String name, String site, int size, String type) {
        this.id = id;
    ...
    protected TrailerResultDTO(Parcel in) {
        id = in.readString();
